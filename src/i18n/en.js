...
export const en = {
  ...
  steps: {
    ...
    stageLabel: "Inside the Soni Transfer app",
    stepWord: "Step",
    items: [
      {
        title: "Enter transfer details",
        body: "Choose how much you want to send and see the exact amount your recipient receives.",
        alt: "Soni Transfer app showing send and receive amounts, exchange rate and fee",
      },
      {
        title: "Payout method",
        body: "Choose the available payout method that works best for your recipient.",
        alt: "Soni Transfer app showing cash pickup, bank deposit and mobile wallet payout choices",
      },
      {
        title: "Pay securely",
        body: "Select a supported payment method, review the transfer and continue securely.",
  ...
  receive: {
    ...
    showcaseLabel: "Payout method",
    send: "Send",
    receiveWord: "Receive",
    phoneAlt: "Soni Transfer app showing the send amount, recipient amount, exchange rate and delivery method",
    chooseTitle: "Choose in the app",
    chooseBody: "Available payout methods update by receiving country.",
    methods: [
