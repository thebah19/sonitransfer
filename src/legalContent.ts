...
export const legalPages: LegalPageContent[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          'Soni Transfer charges the transfer fee displayed before confirmation. Fees may vary by transfer amount, receiving country, channel, or payout method.',
          'Fees are disclosed upfront before transfer confirmation.',
          'Exchange rates are displayed before confirmation and may reflect destination-market guidance and payout-partner requirements.',
  ...
  },
  {
    ...
    description:
      'How Soni Transfer verifies customers, monitors transactions, protects personal data, and meets its payment-service responsibilities.',
    lastUpdated: '25/11/2025',
    version: '2.1',
    sections: [
      {
        title: 'Regulatory information',
        paragraphs: [
          'Soni Transfer Ltd is registered in England and Wales under company number 10832378 and registered with the Financial Conduct Authority as a Small Payment Institution under firm reference number 798474.',
          'Soni Transfer is supervised by HMRC for anti-money laundering compliance under registration number XWML00000122633.',
          'Customer funds are segregated in line with applicable payment-service requirements, but they are not covered by the Financial Services Compensation Scheme.'
        ]
      },
      {
        ...
        paragraphs: [
          'Identity, address, and source-of-funds checks help Soni Transfer protect customers and meet regulatory requirements. Additional information may be requested before a transfer can proceed.'
        ]
      },
      {
        title: 'Transaction monitoring',
        bullets: [
          'Transfers may be reviewed for unusual or suspicious activity.',
          'Customers and recipients may be screened against sanctions requirements.',
          'A transfer may be delayed, suspended, rejected, or cancelled where required for compliance, fraud prevention, or security.'
        ]
      },
      {
        title: 'Secure payment processing',
        paragraphs: [
          'Soni Transfer uses protected payment flows, access controls, and transaction confirmation to help safeguard customer accounts and transfers.'
        ],
        bullets: [
          'Keep account credentials, passwords, and one-time codes private.',
          'Check recipient details carefully before confirming a transfer.',
          'Send money only to people you know and trust.',
          'Contact support immediately if you suspect unauthorised activity.'
        ]
      },
      {
        title: 'Data protection',
        paragraphs: [
          'Soni Transfer handles personal information under UK and applicable EU data-protection law. Access controls, secure hosting, supplier controls, and staff training support the protection of customer data.'
        ]
      },
      {
        title: 'European Economic Area services',
        paragraphs: [
          'Soni Transfer payment services in the European Economic Area are provided through a white-label partnership with Belmoney S.A., a payment institution licensed and supervised by the National Bank of Belgium under registration number 0540.745.997. Belmoney has passport rights to operate in EEA countries in accordance with PSD2.'
        ]
      },
      {
        title: 'Vulnerable customer support',
        paragraphs: [
          'Customers who need extra support or a different way to communicate can contact the Soni Transfer support team. We will work with each customer to make the service easier to use.'
        ]
      },
      {
        title: 'Contact and regulatory links',
        bullets: [
          'Email: support@sonitransfer.com',
          'Telephone: +44 121 532 0769',
          'WhatsApp: +44 7438 473456',
