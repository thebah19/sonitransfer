...
const common = {
  en: {
    ...
    languageShort: 'EN',
    nav: { home: 'Home', about: 'About Us', services: 'Services', app: 'App', faqs: 'FAQs', blog: 'Blog', contact: 'Contact', howItWorks: 'How it works', waysToReceive: 'Ways to receive', help: 'Help', login: 'Log in', signup: 'Sign Up', menu: 'Open menu' },
  ...
  es: {
    ...
    languageShort: 'ES',
    nav: { home: 'Inicio', about: 'Sobre nosotros', services: 'Servicios', app: 'App', faqs: 'Preguntas', blog: 'Blog', contact: 'Contacto', howItWorks: 'Cómo funciona', waysToReceive: 'Formas de recibir', help: 'Ayuda', login: 'Entrar', signup: 'Registrarse', menu: 'Abrir menú' },
  ...
  fr: {
    ...
    languageShort: 'FR',
    nav: { home: 'Accueil', about: 'À propos', services: 'Services', app: 'Appli', faqs: 'FAQ', blog: 'Blog', contact: 'Contact', howItWorks: 'Comment ça marche', waysToReceive: 'Modes de réception', help: 'Aide', login: 'Connexion', signup: "S'inscrire", menu: 'Ouvrir le menu' },
...
const home = {
  en: {
    heroTitle: 'Send money home. Simply.',
    heroCopy: 'A clear £1 fee. Your recipient gets exactly what you see.',
    ...
    calculator: {
      ...
      youSend: 'You send exactly',
      theyReceive: 'Recipient gets exactly',
      deliveryMethod: 'Receive by',
      fee: 'Transfer fee',
      rate: 'Exchange rate',
      delivery: 'Delivery time',
      minutes: 'Minutes',
      exactAmount: 'This is the exact amount they’ll receive.',
      included: 'included',
  ...
  es: {
    heroTitle: 'Envía dinero a casa. Así de simple.',
    heroCopy: 'Una comisión clara de £1. Tu destinatario recibe exactamente lo que ves.',
    ...
    calculator: {
      ...
      youSend: 'Tú envías exactamente',
      theyReceive: 'El destinatario recibe exactamente',
      deliveryMethod: 'Recibir mediante',
      fee: 'Comisión de transferencia',
      rate: 'Tipo de cambio',
      delivery: 'Entrega estimada',
      minutes: 'Minutos',
      exactAmount: 'Este es el importe exacto que recibirá.',
      included: 'incluida',
  ...
  fr: {
    heroTitle: "Envoyez de l'argent à la maison. Tout simplement.",
    heroCopy: 'Des frais clairs de £1. Votre bénéficiaire reçoit exactement le montant affiché.',
    ...
    calculator: {
      ...
      youSend: 'Vous envoyez exactement',
      theyReceive: 'Le bénéficiaire reçoit exactement',
      deliveryMethod: 'Recevoir par',
      fee: 'Frais de transfert',
      rate: 'Taux de change',
      delivery: 'Délai estimé',
      minutes: 'Minutes',
      exactAmount: 'Il s’agit du montant exact que le bénéficiaire recevra.',
      included: 'inclus',
